...
\begin{document}
    ...
    \newline\indent The first elements of the K12 beam-line are three quadrupole magnets (Q1, Q2 and Q3), which are used to focus the beam with a large solid angle acceptance of $\pm2.7$\,mrad 
    ...
    The A1 achromat comprises of four dipole magnets that vertically deflect the beam, the first two which deflect the beam 110\,mm downwards, while the final two deflet the beam upwards towards
