...
\begin{document}
    ...
    The total number of data events passing the selection for 2022 and 2023 was 22,059,350 with the number of $K^+$ decays within the fiducial volume for the 2022 and 2023 dataset was computed as 
    \begin{equation}
        N_K = \frac{N_{selected}}{(A_{2 \pi D} B_{2 \pi D} + A_{\mu 3D} B_{\mu 3D})} =  (4.95 \pm 0.15) \times 10^{12}
    \end{equation}
    ...
    \end{figure}
    The reconstructed masses for data and MC passing the $K_{2 \pi D}$ selection are shown in Figures \ref{fig:signalPlots} and \ref{fig:mee_mc}. The MC samples have been scaled using the calculated $N_K$. 
    \begin{figure}[H]
        \centering 
